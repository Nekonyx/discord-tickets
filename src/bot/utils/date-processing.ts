 ...
 */
export function dateToStr(date: Date = new Date(), format: string = 'D.M.y h:m') {
 ...
 */
export function timestamp(date: Date, style: TimestampStylesString = TimestampStyles.RelativeTime) {
